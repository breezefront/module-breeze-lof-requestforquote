...
define([
    ...
    'mage/translate',
    'jquery/ui'
    //'Lof_All/lib/fancybox/jquery.fancybox' // Breeze fix: commented fancybox
], function($, $t) {
    "use strict";

    $.widget('lof.catalogAddToQuote', {
        component: 'Lof_RequestForQuote/js/catalog-add-to-quote', // Breeze fix: added component name
        options: {
            processStart: null,
            processStop: null,
            bindSubmit: true,
